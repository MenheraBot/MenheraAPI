const urls: { [type: string]: string[] } = {
  ...
  humor: [
    ...
    'https://i.imgur.com/fmgcPWp.png',
    'https://i.imgur.com/kNfVk6P.png',
    'https://i.imgur.com/2z2jfTg.png',
